...
static void configure_governor()
{
    ...
    if (strncmp(governor, "ondemand", 8) == 0) {
        ...
        sysfs_write("/sys/devices/system/cpu/cpufreq/ondemand/optimal_freq", "972000");
        sysfs_write("/sys/devices/system/cpu/cpufreq/ondemand/sync_freq", "1188000");
        ...
        sysfs_write("/sys/devices/system/cpu/cpufreq/interactive/hispeed_freq", "1188000");
